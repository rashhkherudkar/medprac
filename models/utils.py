...
class MedicalInsurance():
    ...
    def load_model(self):
        with open (r"C:\Users\Rahul\Desktop\40_Rashmi_kherudkar_medical\models\project_data.json","r") as f:
            self.json_data=json.load(f)

        with open (r"C:\Users\Rahul\Desktop\40_Rashmi_kherudkar_medical\models\Linear_model.pkl","rb") as f:
